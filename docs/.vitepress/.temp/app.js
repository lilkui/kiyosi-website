...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"kiyosi","description":"C++23 derivatives pricing with Python bindings. Learn to price vanilla options, exotic instruments, and structured products.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteTitle":"kiyosi","nav":[{"text":"Guide","link":"/guide/introduction","activeMatch":"/guide/"},{"text":"Python API","link":"/reference/python","activeMatch":"/reference/"},{"text":"C++","link":"/cpp/building","activeMatch":"/cpp/"}],"sidebar":[{"text":"Get started","items":[{"text":"Introduction","link":"/guide/introduction"},{"text":"Installation","link":"/guide/installation"},{"text":"Your first price","link":"/guide/first-price"}]},{"text":"Explore kiyosi","items":[{"text":"Pricing engines","link":"/guide/engines"},{"text":"Python API overview","link":"/reference/python"},{"text":"Build the C++ library","link":"/cpp/building"}]}],"search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/lilkui/kiyosi"}],"outline":{"level":[2,3]},"footer":{"message":"kiyosi · Open-source derivatives pricing","copyright":"<a href=\\"https://github.com/lilkui/kiyosi/blob/main/LICENSE.txt\\">Project released under the MIT License</a>"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.D21t6Pmp.js"));
