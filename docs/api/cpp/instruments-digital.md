...
- `option_type` — Call-or-put direction.
- `strike` — Positive strike price.
- `payout` — Positive finite cash amount paid in the money.
- `effective_date` — First date of the option life.
- `expiry_date` — Final date of the option life.
